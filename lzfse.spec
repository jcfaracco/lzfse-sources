...
Vendor:         Apple Inc.
BuildRoot:      %_topdir/%{name}-%{version}-%{release}.x86_64
...
%define _rpmfilename lzfse-1.0-1.x86_64.rpm
...
mv %{name}-%{version}-%{release}.x86_64/* $RPM_BUILD_ROOT/
